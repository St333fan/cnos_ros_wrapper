...
topic = '/object_detector/cnos_custom'
...
def plot_images(images, titles=['Original', 'BBs', 'Masks']):
    ...
    #save img instead of show
    plt.savefig('/code/custom_data/cnos_custom_results.png')
    # plt.show()

if __name__ == '__main__':
    node = rospy.init_node('test_object_detector')
    rgb_path = "/code/custom_data/20240620_165746.png"
